    ...
    <div className="flex flex-col items-center p-6">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="text-center">
          ...
          <Image src="/images/MechTeam.jpg" width={300} height={200} />
        </div>

        {/* ElectricalTeam */}
        <div className="text-center">
          <h2 className="text-lg font-semibold mb-2">Electrical Team</h2>
          <Image src="/images/ElectricalTeam.jpg" width={300} height={200} />
        </div>

        {/* SoftwareTeam */}
        <div className="text-center">
          <h2 className="text-lg font-semibold mb-2">Software Team</h2>
          <Image src="/images/SoftwareTeam.jpg" width={300} height={200} />
        </div>

        {/* ScienceTeam */}
        <div className="text-center">
          <h2 className="text-lg font-semibold mb-2">Science Team</h2>
          <Image src="/images/ScienceTeam.jpg" width={300} height={200} />
        </div>
      </div>
    </div>
  );
